...
public abstract class TestBase {
    ...
    //JSexecutor SendKeys
    public void jsSendKeys(String message,WebElement webElement){
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].value='"+message+"'",webElement);
    }
